...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "No rectangle looks like a square",
            -1,
            {
                "question": "The dimensions of four rectangles are given above. Which rectangle do you think looks most like a square? Explain your reasoning using complete sentences.",
                "expectations": [
                    {"ideal": "The closer a ratio of the sides in a rectangle is to one, the more it looks like a square."},
            ...
            [ExpectationClassifierResult(
                ...
                ExpectationClassifierResult(
                    expectation=0, evaluation="Bad", score=0.05
                ),
            ],
        ),
        (
            "rectangle with dimension 37 x 40",
            -1,
            {
                "question": "The dimensions of four rectangles are given above. Which rectangle do you think looks most like a square? Explain your reasoning using complete sentences.",
                "expectations": [
            ...
            [ExpectationClassifierResult(
                    expectation=0, evaluation="Bad", score=0.1
                ),
                ExpectationClassifierResult(
                    expectation=1, evaluation="Good", score=0.9
                ),
            ],
        ),
        (
            "if ratio of sides is close to 1 then it will look more like a square",
            -1,
            {
                "question": "The dimensions of four rectangles are given above. Which rectangle do you think looks most like a square? Explain your reasoning using complete sentences.",
                "expectations": [
            ...
            [ExpectationClassifierResult(
                    expectation=1, evaluation="Good", score=0.8
                ),
                ExpectationClassifierResult(
                    expectation=0, evaluation="Bad", score=0.1
                ),
