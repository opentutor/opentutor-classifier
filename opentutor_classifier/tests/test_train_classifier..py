...
from opentutor_classifier.lr.train import (
    train_data_root,
    train_online,
    train_default_classifier,
)
from opentutor_classifier.lr.utils import load_config, dict_to_config
from .helpers import (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        #     [
        #         ExpectationClassifierResult(
        #             evaluation="Good", score=0.8, expectation=0
        #         ),
        #         ExpectationClassifierResult(
        #             evaluation="Bad", score=0.7, expectation=1
        #         ),
        #         ExpectationClassifierResult(
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            [
                [
                ExpectationClassifierResult(evaluation="Good", score=0.9, expectation=0),
                ...
                [
                ExpectationClassifierResult(evaluation="Good", score=0.8, expectation=0),
                ExpectationClassifierResult(evaluation="Bad", score=0.6, expectation=1),
                ExpectationClassifierResult(evaluation="Bad", score=0.7, expectation=2),
                ],
                [
                ExpectationClassifierResult(evaluation="Bad", score=.65, expectation=0),
                ExpectationClassifierResult(evaluation="Good", score=0.55, expectation=1),  #problem
                ExpectationClassifierResult(evaluation="Bad", score=0.59, expectation=2),
                ],
                [
                ExpectationClassifierResult(evaluation="Bad", score=0.67, expectation=0),
                ExpectationClassifierResult(evaluation="Bad", score=0.58, expectation=1),
                ExpectationClassifierResult(evaluation="Good", score=0.9, expectation=2),
                ],
            ],
        ),
        (
            ...
            [
                "It is not uniform.",
                "there is an uniformity and each candle is buring at constant rate.",
                "ratio of length that candle A had burned to Candle B had burned is not constant."
            ],
            [
                ExpectationTrainingResult(accuracy=0.80),
                ExpectationTrainingResult(accuracy=0.80),
            ...
            [
                [
                ExpectationClassifierResult(evaluation="Bad", score=0.55, expectation=0),
                ExpectationClassifierResult(evaluation="Bad", score=0.56, expectation=1),
                ExpectationClassifierResult(evaluation="Bad", score=0.60, expectation=2),
                ExpectationClassifierResult(evaluation="Bad", score=0.65, expectation=3),
                ],
                [
                ExpectationClassifierResult(evaluation="Good", score=0.65, expectation=0), #problem
                ExpectationClassifierResult(evaluation="Bad", score=0.6, expectation=1),
                ExpectationClassifierResult(evaluation="Bad", score=0.7, expectation=2),
                ExpectationClassifierResult(evaluation="Bad", score=0.71, expectation=3)
                ],
                [
                ExpectationClassifierResult(evaluation="Good", score=0.65, expectation=0), #problem
                ExpectationClassifierResult(evaluation="Bad", score=0.58, expectation=1), 
                ExpectationClassifierResult(evaluation="Good", score=0.63, expectation=2),
                ExpectationClassifierResult(evaluation="Bad", score=0.60, expectation=3),
                ]
            ],
        )
    ],
...
def test_trained_default_model_usable_for_inference(
    ...
    classifier = LRAnswerClassifier(model_root=output_dir, shared_root=shared_root)
